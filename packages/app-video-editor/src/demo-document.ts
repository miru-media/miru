    ...
    children: [
      {
        ...
        sourceStart: 3,
        duration: 3,
        sourceRef: { assetId: assets.waves.id },
        ...transform1080p,
      ...
      },
      {
        ...
        sourceStart: 2,
        duration: 4,
        sourceRef: { assetId: assets.wavesRocks.id },
        ...transform1080p,
      ...
      },
      {
        ...
        sourceStart: 3,
        duration: 3,
        sourceRef: { assetId: assets.waveBreaking.id },
        ...transform720p,
      ...
      },
      {
        ...
        sourceStart: 2.18,
        duration: 5,
        sourceRef: { assetId: assets.turtle.id },
        ...transform720p,
    ...
    children: [
      {
        ...
        sourceStart: 19,
        duration: 10,
        sourceRef: { assetId: assets.wavesAudio.id },
      },
      {
        id: uid(),
        type: 'clip',
        ...
        sourceStart: 0,
        duration: 5,
        sourceRef: { assetId: assets.underwaterAudio.id },
      },
      {
        id: uid(),
        type: 'clip',
