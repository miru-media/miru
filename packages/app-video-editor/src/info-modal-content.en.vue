<template>
  <div class="bulma-modal-card-body">
    ...
    <div>
      <p>
        Hi and welcome to our free and open source online video editor. Try it out and send us feedback on
        <a target="_blank" href="https://discord.gg/mmwMvf4Pnv">Discord</a>,
        <a target="_blank" href="https://codeberg.org/miru-media/miru">Codeberg</a>, or
      ...
      <ul class="task-list">
        ...
        <li>
          ...
          Transitions and crossfade effects,
        </li>
        <li>
          <div class="task-todo"></div>
          Subtitles,
