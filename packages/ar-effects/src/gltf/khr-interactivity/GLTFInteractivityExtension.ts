...
import { registerNodes } from './behaveNodes'
import { convertGraph } from './convertGraph'
...
export class GLTFInteractivityExtension implements GLTFLoaderPlugin {
  ...
  emit(op: string, emittedValues: Record<string, unknown>, filter = (_nodes: Behave.EventNode) => true) {
